...
(async function run() {
  ...
  try {
    ...
    assert.match(root.body.toString('utf8'), /application-name" content="JCJH Timetable"/);
      assert.match(root.body.toString('utf8'), /domain-match\.js\?v=20260915-schedule-email-guard1/);
      assert.match(root.body.toString('utf8'), /ui-request\.js\?v=20260904-calendar-new-tab/);
      assert.match(root.body.toString('utf8'), /20260915-homeroom-revoke-money-format1/);
