...
(async function run() {
  ...
  try {
    ...
    assert.match(root.body.toString('utf8'), /application-name" content="JCJH Timetable"/);
      assert.match(root.body.toString('utf8'), /domain-match\.js\?v=20260917-[^"]+/);
      assert.match(root.body.toString('utf8'), /ui-request\.js\?v=20260917-[^"]+/);
      assert.match(root.body.toString('utf8'), /app\.js\?v=20260917-[^"]+/);
